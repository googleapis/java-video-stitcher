...
[google-cloud-java/java-video-stitcher](
https://github.com/googleapis/google-cloud-java/tree/main/java-video-stitcher).
This repository will be archived in the future.
Future releases will appear in the new repository (https://github.com/googleapis/google-cloud-java/releases).
The Maven artifact coordinates (`com.google.cloud:google-cloud-video-stitcher`) remain the same.
...
```Groovy
implementation 'com.google.cloud:google-cloud-video-stitcher:0.12.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-video-stitcher" % "0.12.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-video-stitcher/0.12.0
