...
```Groovy
implementation 'com.google.cloud:google-cloud-video-stitcher:0.13.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-video-stitcher" % "0.13.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-video-stitcher/0.13.0
